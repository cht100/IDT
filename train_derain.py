...
parser.add_argument('--crop_size', type=int, default=256, help='crop size for network')       #default=128
parser.add_argument('--num_workers', type=int, default=1)
parser.add_argument('--gpu_ids', type=str, default='1', help='gpu ids: e.g. 0  0,1,2, 0,2. -1 for CPU')
...
parser.add_argument('--data_path', type=str, default="/data1/jiangtaoren/datasets/RainDrop")
parser.add_argument('--save_path', type=str, default="/data1/jiangtaoren/16-baselines-restoration/methods/IDT/result/")
